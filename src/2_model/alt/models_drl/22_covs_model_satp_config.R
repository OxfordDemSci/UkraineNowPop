...
init_generator <- function(md = md, chain_id = 1) {
  ...
  result[["delta_p_F"]] <- rnorm(md$T, 0, 0.1)
  result[["sigma_delta_p_F"]] <- runif(1, 0, 0.1)
  result[["gamma_p_F"]] <- rnorm(md$I, 0, 0.1)
  result[["sigma_gamma_p_F"]] <- runif(1, 0, 0.1)
  ...
  result[["delta_p_G"]] <- rnorm(md$T, 0, 0.1)
  result[["sigma_delta_p_G"]] <- runif(1, 0, 0.1)
  result[["gamma_p_G"]] <- rnorm(md$I, 0, 0.1)
  result[["sigma_gamma_p_G"]] <- runif(1, 0, 0.1)
