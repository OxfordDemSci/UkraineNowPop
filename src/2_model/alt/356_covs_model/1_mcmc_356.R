...
mod <- cmdstan_model(file.path(src_dir, "models", paste0(model_name, ".stan")), cpp_options = list(stan_threads = TRUE))
#mod$compile()
...
fit <- mod$sample(
    ...
    #metric = "dense_e"
    #adapt_delta = 0.9
    #init_buffer = 15,  #increase to 20-25 if needed
    #window = 75, #increse to 80-85 if needed
    #term_buffer = 10   #increase to 25 if needed
  )
