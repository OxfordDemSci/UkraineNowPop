...
## multi-source_statistical
This is a Bayesian statistical modelling framework designed to integrate multiple data sources for population nowcasting, including estimates of uncertainty. The two data sources used in these models are daily or monthly counts of active users or Facebook and Instagram at the Oblast level each day. 